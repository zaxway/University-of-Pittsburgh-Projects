...
// function setup() {
//     // when you click the gameboard make a post to the server
//     document.getElementById("gameboard").addEventListener("click", makePost, true);
// }
//
// function makePost() {
//   // on the post, we want to post what the first player selected
...
//   alert("gets here");
// 	httpRequest.open("POST", "/game/<game_id>/");
//   // by "this", I am talking about the connect 4 game
// 	httpRequest.send(JSON.stringify(this)); // just send the whole thing
// }
//
...
//       // now that it has been posted to the server, set myTurn = True.
//       // this basically says that the first players turn has ended.
//       myTurn = true;
// 		}
//     else {
//       // if not posted to server, do a timeout of 1 second till it is posted.
//       window.setTimeout(handlePost, 1000);
// 		}
// 	}
// }
//
...
//    };
// 	httpRequest.open("GET", "/game/<game_id>/");
// 	httpRequest.send();
// }
//
...
// 	if (httpRequest.readyState === 4) {
// 		if (httpRequest.status === 200) {
//       // at this point the package is recieved, with the full JSON file.
//       // this is stored into an array, and now we get specific elements
//       // from the array.
//       var arr = JSON.parse(httpRequest.responseText);
//       // we then use innerHTML to display these elements into the game.html file.
//
// 		} else {
//       window.setTimeout(handlePoll, 1000);
