...
public class Assig2
{
	public static void main(String [] args)
	{
		...
		// Added Extra Credit Driver print statements
		System.out.println();
		System.out.println("This is the EXTRA CREDIT!!");
		System.out.println("After adding up all the key values, the total sum is: ");
		System.out.println("total = " + A.array_sum()); // Extra credit print statement
		System.out.println();
